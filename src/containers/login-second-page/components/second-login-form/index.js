								...
								<div className="registerBox col-md-12">
									<form onSubmit={handleSubmit(this.handleChoose)}>
										<div className="form-group regForm">
											<p>
												Please pass the two-factor authentication using your
												mobile phone, we will send you a sms with code. Please
												don`t share the code to anyone, but only use it on the
												Titus Global website to authenticate.
											</p>
										</div>
										<button
											type="submit"
