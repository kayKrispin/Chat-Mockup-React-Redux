  ...
  render() {
    ...
    <div className='mainBlock' >
      ...
      <div className="form-group regForm">
          <Field  name="FirstName" icon={'fas fa-user-alt'}  type="text" label='First Name' component={renderField}/>
     </div>
      <div className="form-group  regForm">
          <Field  name="LastName"  type="text" icon={'fas fa-user-alt'} label='Last Name' component={renderField}/>
     </div>

      <div className="form-group  regForm">
          <Field  name="Email"  type="text" icon={'fas fa-at'} label='Email' component={renderField}/>
     </div>


      <div className="form-group  regForm">
          <Field  name="Phone"  type="text" icon={"fas fa-mobile-alt"} label='Phone' component={renderField}/>
     </div>

      <div className="form-group  regForm">
          <Field  name="Password"  type="text" icon={'fas fa-lock'} label='Password' component={renderField}/>
     </div>

      <div className="form-group  regForm">
          <Field  name="ConfirmPassword"  icon={'fas fa-lock'} type="text" label='Confirm Password' component={renderField}/>
     </div>
